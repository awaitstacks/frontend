...
//         <div className="
//  w-full 
//  max-w-[90%] xs:max-w-[88%] sm:max-w-md md:max-w-lg 
//  lg:max-w-xl xl:max-w-2xl 2xl:max-w-2xl
//  mx-auto
...
//               Please {state === "Sign up" ? "sign up" : "log in"} to continue exploring
//             </p>
//           </div>
...
//             type="submit"
//             className="
//               w-full py-4 bg-gradient-to-r from-indigo-500 to-blue-500 
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-8 sm:py-12">
      ...
      >
        ...
        <div className="relative z-10 space-y-6 sm:space-y-8">
          ...
          {state === "Sign up" && (
            <div>
              <label className="block text-gray-700 font-medium mb-1.5 text-sm xs:text-base">Full Name</label>
              <input
                className="
          ...
          {/* Email */}
          <div>
            <label className="block text-gray-700 font-medium mb-1.5 text-sm xs:text-base">Email</label>
            <input
              className="
                w-full px-4 xs:px-5 py-3 rounded-2xl border border-gray-300/50 
                bg-white/40 backdrop-blur-sm focus:border-indigo-400 
          ...
          {/* Password */}
          <div>
            <label className="block text-gray-700 font-medium mb-1.5 text-sm xs:text-base">Password</label>
            <input
              className="
                w-full px-4 xs:px-5 py-3 rounded-2xl border border-gray-300/50 
                bg-white/40 backdrop-blur-sm focus:border-indigo-400 
