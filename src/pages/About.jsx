      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center mb-24">
          ...
          <div className="relative group">
            ...
            <div className="absolute inset-0 bg-gradient-to-tr from-blue-600/20 to-indigo-700/10 rounded-3xl blur-xl group-hover:blur-2xl transition-all duration-700 opacity-0 group-hover:opacity-100"></div>

            {/* Image container with overflow hidden and rounded corners */}
            <div className="relative overflow-hidden rounded-3xl shadow-2xl">
              {/* Inner wrapper for smooth centered zoom */}
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
              <p>
                ...
                <span></span> was founded by Vinoth K S and Giridharan K,
                college graduates from 2020. Starting with a YouTube channel, we
                launched our first group trip in February 2022. With above 3
                years of experience planning and conducting group tours across
                India, we specialize in end-to-end group packages and customized
                family itineraries. "GV" stands for Giridharan and Vinoth —
                dedicated to creating seamless, meaningful travel experiences.
              </p>
              <p>
        ...
        <div className="text-center py-16 bg-white/60 backdrop-blur-sm rounded-3xl shadow-xl">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-6 px-4">
            Let’s Create Your Perfect Journey
          </h2>
          <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed px-6">
