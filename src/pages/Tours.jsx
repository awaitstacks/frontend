...
const Tours = () => {
  ...
  useEffect(() => {
    ...
    setFilterTour(filtered);
    setVisibleCount(5);
  }, [tours, batch, activeCategory, selectedYear, selectedMonth, availability, searchTerm]);
    ...
    >
      ...
      ">
        ...
        {filterTour.length === 0 ? (
          <div className="text-center py-20 bg-white/70 backdrop-blur-md rounded-3xl border border-gray-100">
            <p className="text-gray-500 font-medium text-lg">
              {batch || selectedMonth !== "all" || selectedYear !== "all" || availability !== "available" || activeCategory
