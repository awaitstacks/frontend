...
//         numberOfDays: "", specialRequests: "", source: "",
//     });
...
//             ...formData, adults: counts.a, children: counts.c, infants: counts.i,
//         });
//         if (result.success) {
//             setSubmitted(true);
//             setTimeout(() => {
//                 setSubmitted(false);
//                 setFormData({ fullName: "", mobileNumber: "", email: "", city: "", destination: "", tourType: "", preferredTravelDate: "", numberOfDays: "", specialRequests: "", source: "" });
...
//     const fieldStyle = { width: "100%", border: "1px solid #e2e8f0", borderRadius: "8px", padding: "10px 12px 10px 34px", fontSize: "14px", color: "#0f172a", outline: "none", boxSizing: "border-box", background: "#fff" };
...
//                     /* no max-height on desktop — unchanged */
//                 }
...
//                     {/* Header */}
//                     <div className="enq-header" style={{ position: "relative", minHeight: "100px", display: "flex", flexDirection: "column", justifyContent: "center", padding: "24px 36px", overflow: "hidden", background: "linear-gradient(135deg, #1a3c5e 0%, #1a3c5e 50%, #1d6a4a 100%)" }}>
...
//                                     </div>
//                                     <div className="enq-grid-4" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "14px" }}>
//                                         {[
//                                             { label: "Full Name", name: "fullName", icon: "👤", placeholder: "Enter your full name", required: true },
//                                             { label: "Mobile Number", name: "mobileNumber", icon: "📞", placeholder: "+91 98765 43210", required: true },
...
//                                                 <input className="enq-input" name="destination" value={formData.destination} onChange={handleChange} required placeholder="e.g. Manali, Bali" style={fieldStyle} />
//                                             </div>
//                                         </div>
//                                         <div>
...
//                                             <div style={{ position: "relative" }}>
//                                                 <span className="enq-icon" style={{ position: "absolute", left: "10px", top: "50%", transform: "translateY(-50%)", fontSize: "14px" }}>📅</span>
//                                                 <input className="enq-input" name="preferredTravelDate" value={formData.preferredTravelDate} onChange={handleChange} required type="date" style={fieldStyle} />
//                                             </div>
//                                         </div>
//                                         <div>
...
//                                             </div>
//                                         ))}
//                                         <div className="enq-total-card" style={{ background: "#eff6ff", border: "1px solid #bfdbfe", borderRadius: "10px", padding: "12px 12px", textAlign: "center" }}>
...
//                                                 style={{ width: "100%", border: "1px solid #e2e8f0", borderRadius: "8px", padding: "10px 12px", fontSize: "14px", color: "#0f172a", outline: "none", resize: "none", boxSizing: "border-box", background: "#fff" }} />
//                                         </div>
//                                         <div>
        ...
        <>
            <style>{`
                ...
                @media (max-width: 767px) {
                    ...
                    .enq-header { padding: 14px 18px !important; min-height: 72px !important; }
                    .enq-header h2 { font-size: 17px !important; }
                    .enq-header p { font-size: 11px !important; margin-top: 3px !important; }
                    .enq-header img { width: 28px !important; height: 28px !important; }
                    .enq-header .enq-close-btn { width: 26px !important; height: 26px !important; font-size: 13px !important; }
    ...
    .enq-tour-row2 { grid-template-columns: 1fr !important; }
            ...
            <div className="enq-overlay" onClick={(ev) => { if (ev.target === ev.currentTarget) onClose?.(); }}>
                <div className="enq-modal">
                    ...
                    {/* Header — fixed top */}
                    <div className="enq-header" style={{ position: "relative", minHeight: "100px", display: "flex", flexDirection: "column", justifyContent: "center", padding: "24px 36px", overflow: "hidden", background: "linear-gradient(135deg, #1a3c5e 0%, #1a3c5e 50%, #1d6a4a 100%)", flexShrink: 0 }}>
                        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(135deg, rgba(65, 169, 89, 0.92) 40%, rgba(239, 40, 9, 0.85) 100%)" }} />
                        <button onClick={onClose} className="enq-close-btn" style={{ position: "absolute", top: "14px", right: "14px", width: "32px", height: "32px", borderRadius: "50%", background: "rgba(255,255,255,0.2)", border: "none", color: "#fff", fontSize: "16px", fontWeight: "bold", cursor: "pointer", zIndex: 10, display: "flex", alignItems: "center", justifyContent: "center" }}>✕</button>
                        <h2 style={{ color: "#fff", fontSize: "24px", fontWeight: 700, position: "relative", zIndex: 2, margin: 0, display: "flex", alignItems: "center", gap: "10px" }}>
                            <img src={assets.mapImg} alt="map" style={{ width: "38px", height: "38px", objectFit: "contain", mixBlendMode: "multiply" }} />
