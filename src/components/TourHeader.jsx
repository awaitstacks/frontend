...
const TourHeader = () => {
  return (
    //<section className="relative overflow-hidden bg-white py-24 md:py-36">
     <section className="relative my-16 md:my-24 lg:my-32 overflow-hidden bg-gradient-to-br from-blue-50 via-white to-indigo-50/30 rounded-3xl shadow-lg mx-4 sm:mx-8 md:mx-12 lg:mx-20 xl:mx-32">      {/* Very subtle calming wave pattern overlay */}
