...
const TourHeader = () => {
  return (
    ...
    <section className="relative my-6 md:my-10 lg:my-12 overflow-hidden bg-gradient-to-br from-blue-50 via-white to-indigo-50/30 rounded-3xl shadow-lg mx-4 sm:mx-8 md:mx-12 lg:mx-20 xl:mx-32">
