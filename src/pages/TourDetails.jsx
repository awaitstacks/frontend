...
//       { size: 14 }
//     );
//     if (tour.completedTripsCount > 0) {
//       addText(`Successfully Completed: ${tour.completedTripsCount} Trips`, {
//         size: 14,
//         color: "#166534",
//       });
//     }
//     if (!tour.available) {
//       addText("Status: Sold Out", { size: 14, color: "#dc2626" });
//     }
//     y += 10;
...
//     addText(`Double Sharing: ${tour.price.doubleSharing?.toLocaleString()}`, {
//       size: 12,
//     });
//     addText(`Triple Sharing: ${tour.price.tripleSharing?.toLocaleString()}`, {
//       size: 12,
//     });
//     if (tour.price.childWithBerth)
//       addText(
//         `Child with Berth: ${tour.price.childWithBerth.toLocaleString()}`,
//         { size: 12 }
//       );
//     if (tour.price.childWithoutBerth)
//       addText(
//         `Child without Berth: ${tour.price.childWithoutBerth.toLocaleString()}`,
//         { size: 12 }
//       );
//     y += 5;

//     addText("Advance Payment Required", { size: 14, bold: true });
//     addText(`Adult: ${tour.advanceAmount.adult?.toLocaleString()}`, {
//       size: 12,
//     });
//     addText(`Child: ${tour.advanceAmount.child || 0}`, {
//       size: 12,
//     });
//     y += 10;
...
//         addText(`• ${addon.name}: ${addon.amount} INR`, {
//           size: 12,
//         });
//       });
//       y += 5;
...
//         { size: 13 }
//       );
//       addText(`Double Sharing: ${v.price.doubleSharing?.toLocaleString()}`, {
//         size: 13,
//       });
  ...
  const SoldOutMessage = () => (
    <div className="text-center py-16 px-6 bg-gradient-to-b from-red-50 to-white rounded-3xl shadow-xl border border-red-100 max-w-4xl mx-auto animate-fade-up">
      ...
      <p className="text-lg sm:text-xl text-gray-700 mb-8 leading-relaxed max-w-2xl mx-auto">
        We're sorry, but all seats for this batch have been booked. Thank you for your interest!
      </p>
      <p className="text-base text-gray-600 mb-10">
        Check out our other upcoming tours or join the waitlist for future batches.
      </p>
